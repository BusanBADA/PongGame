...
게임 시작부터 흘러간 시간이 게임 화면 중앙 상단에 출력됨.
...
임시 객체인 직사각형 오브젝트에 공이 맞고 튕겨 남.

공이 상하좌우 화면 벽을 맞고 튕겨 남.

공이 우측 벽을 맞고 튕기면 플레이어A 스코어 1 획득.

화면 좌측 상단에 플레이어A 스코어 출력.

화면 좌측 벽을 맞고 튕기면 플레이어B 스코어 1 획득.

화면 우측 상단에 플레이어B 스코어 출력.
